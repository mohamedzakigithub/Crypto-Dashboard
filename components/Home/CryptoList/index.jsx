...
export default function Index() {
  ...
  return (
    <VStack>
      ...
      >
        <Text fontSize="lg">
          This tab displayes a table listing cryptocurrencies ordered by market
          cap rank with symbol, name, market cap and current price. The table
          displays 100 rows per page. Click on the previous or next button to
          navigate to another page. Type in the text input below to filter
          displayed coins in the page by symbol or coin name.
        </Text>
      </Box>
